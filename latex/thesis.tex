...
\include{chapters/03-trust-problem}
\include{chapters/04-trust-framework}
\include{chapters/05-governance}

% Part III: Operational Patterns
\part{Operational Patterns}
\include{chapters/06-observability-patterns}
\include{chapters/07-triage-patterns}
\include{chapters/08-remediation-patterns}
...
[Year] & MSc, [University], [Field] \\
[Year] & BSc, [University], [Field] \\
\end{tabular}
...
[Aasta] & MSc, [Ülikool], [Eriala] \\
[Aasta] & BSc, [Ülikool], [Eriala] \\
\end{tabular}
